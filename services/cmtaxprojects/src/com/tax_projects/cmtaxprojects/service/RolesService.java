...
public interface RolesService {
    ...
    /*
     * Returns the associated userses for given Roles id.
     *
    ...
    /*
     * Returns the associated workstatuses for given Roles id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Workstatus instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Workstatus> findAssociatedWorkstatuses(Integer id, Pageable pageable);
