...
import com.tax_projects.cmtaxprojects.service.OfficesService;
...
public class OfficesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Offices getOffices(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Offices editOffices(@PathVariable("id") Integer id, @RequestBody Offices offices) {
        LOGGER.debug("Editing Offices with id: {}" , offices.getId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOffices(@PathVariable("id") Integer id) {
    ...
    public Page<Projects> findAssociatedProjectses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return officesService.findAssociatedProjectses(id, pageable);
    }
