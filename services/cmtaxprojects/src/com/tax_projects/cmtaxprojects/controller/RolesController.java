...
import com.tax_projects.cmtaxprojects.service.RolesService;
 ...
 * @see Roles
 */
@RestController("cmtaxprojects.RolesController")
@Api(value = "RolesController", description = "Exposes APIs to work with Roles resource.")
@RequestMapping("/cmtaxprojects/Roles")
public class RolesController {

    private static final Logger LOGGER = LoggerFactory.getLogger(RolesController.class);

    @Autowired
	@Qualifier("cmtaxprojects.RolesService")
    ...
    public Page<Users> findAssociatedUserses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return rolesService.findAssociatedUserses(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/workstatuses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the workstatuses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Workstatus> findAssociatedWorkstatuses(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated workstatuses");
        return rolesService.findAssociatedWorkstatuses(id, pageable);
    }
